...
export default function App(){
 ...
 return <div className="office-universe of-app">
  ...
  <header className="of-header"><OfficeBrand/><span className="of-header-caption">A shared place to think & work.</span><nav aria-label="Product links"><a href="#the-idea">The idea</a><a href="/presentation">Walkthrough <span aria-hidden="true">↗</span></a></nav><span className="of-header-avatar" aria-label="Maya, fictional demo owner">MC</span></header>
