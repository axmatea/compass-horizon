...
const server = createServer(async (req,res) => {
 ...
 try {
  ...
  const route = ['/acquisition','/acquisition/app','/login'].includes(normalized) ? '/acquisition.html'
   ...
   : normalized === '/' ? '/index.html' : ['/presentation','/presentation/legacy','/story'].includes(normalized) ? '/story.html' : ['/app','/office','/presentation/finale','/demo/table','/demo/workspace','/demo/remaster','/demo/remaster/app'].includes(normalized) ? '/app.html' : pathname;
