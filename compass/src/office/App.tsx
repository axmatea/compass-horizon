...
export default function App(){
 ...
 return <div className="office-universe of-app">
  ...
  <header className="of-header"><OfficeBrand/><span className="of-header-caption">The original studio concept.</span><nav aria-label="Product links"><a href="/">Current site</a><a href="/original/site">Early website</a><a href="/original/tour">Office guide <span aria-hidden="true">↗</span></a></nav><span className="of-header-avatar" aria-label="Maya, fictional demo owner">MC</span></header>
