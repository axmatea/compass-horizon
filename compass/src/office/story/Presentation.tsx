  ...
  return <div className="office-universe office-story os-presentation" data-slide={active + 1}>
    ...
    <main className="os-deck-main" ref={main} aria-labelledby="os-slide-title">
      <section key={active} className={`os-slide os-slide-${active + 1}`} aria-label={`Scene ${active + 1} of 6`}>
        ...
        {active === 5 && <div className="os-outcome"><div>{title(<>Right context.<br /><em>Right person.</em></>)}<p className="os-outcome-line">Six seats. One plan.<br />Only the necessary coordination.</p></div><div className="os-outcome-summary"><p><span>Review the dependency</span><strong>Noa + Leo</strong></p><p><span>Keep the decision</span><strong>Maya</strong></p><p><span>Stay with their work</span><strong>Esra · Ravi · Sam</strong></p><p><span>Preserve the shared commitment</span><strong>Friday, October 2 · 15:00</strong></p><a href="/studio" className="of-button of-button-primary">Explore the local office <span aria-hidden="true">↗</span></a><p className="os-fine">An intended outcome, not an approved or executed change.</p></div></div>}
